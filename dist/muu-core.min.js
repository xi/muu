(function(r,q,n){(function(k){"object"===typeof module&&"object"===typeof module.exports?module.exports=k(require("lodash")):"function"===typeof define&&define.amd?define("muu",["lodash"],k):r.muu=k(r._)})(function(k){var p={};p["js-helpers"]={instance:k};var t=function(d,f){for(var g=[],a=0;a<d.length;a++)g.push(f(d[a]));return g};k=function(d,f,g){p[d]={deps:f,factory:g}};var s=function(d){if(!p[d])return n;p[d].instance||(p[d].instance=p[d].factory.apply(n,t(p[d].deps,s)));return p[d].instance};
